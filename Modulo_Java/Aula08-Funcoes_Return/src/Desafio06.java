...
/*Poker é um jogo muito conhecido pela sua ligação com a matemática, afinal, a partir de uma série de cartas que 
 * os jogadores podem ter em mãos, existe uma possibilidade limitada de combinações.
...
Supondo um jogo onde os jogadores têm 5 cartas na mão, crie funções para verificar se as 5 cartas formam cada um 
dos 4 jogos acima.
*/
