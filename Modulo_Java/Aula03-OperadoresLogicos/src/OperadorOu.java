...
public class OperadorOu {
	...
	public static void main(String[] args) {
		/*Faça um programa que receba o total de compras de um usuário e um cupom. Se o total de compas 
		 * exceder 1000 ou se o cupom for igual a DESCONTO20, aplicar um desconto de 20% na compra*/
